...
namespace ClientWPF.ViewModels
{
    ...
    {
        private ImageMessage currentImageMessage;
        public ImageMessage CurrentImageMessage
        {
            get { return currentImageMessage; }
            set
            {
                if (value != null || value != currentImageMessage)
                {
                    currentImageMessage = value;
                    OnPropertyChanged("CurrentImageMessage");
                }
            }
        }
        ...
        //internal void SendCurrentImageMessage()
        //{
        //    if (!string.IsNullOrEmpty((this.CurrentMessage as ImageMessage).Image))
        //    {
        //        // Invokes the Send method on the server, which in turn invokes the broadcastMessage of all clients.
        //        this.Proxy.Invoke("Send", this.UserName, this.CurrentMessage.Text);
        //    }
